...
public class FindDuplicate_PDF_Test {
	...
	*/
	...
	public void checkDuplicateImageAmsan() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/amsan-cleansource-janpak/amsan-cleansource-janpak-contract/");
	...
	public void checkDuplicateImageHaworth() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/haworth/haworth-contract/");
	...
	public void checkDuplicateImageAcro() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/acro-service-corporation/acro-service-corporation-contracts/");
	...
	public void checkDuplicateImageGametime() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/gametime/gametime-contract/");
	...
	public void checkDuplicateImageBsnSports() throws MalformedURLException, IOException { 
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/bsn-sports-and-us-games/bsn-sportsus-games-contract/");
	...
	public void checkDuplicateImageCintas() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/cintas/cintas-contract/");
	...
	public void checkDuplicateImageEmpireToday() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/empire-today/empire-today-contract/");
	...
	public void checkDuplicateImageGraybarElectrical() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/graybar-electrical/graybar-electrical-contract/");
	...
	public void checkDuplicateImageGraybarLed() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/graybar-led/graybar-led-contract/");
	...
	public void checkDuplicateImageHermanMiller() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/herman-miller/herman-miller-contract/");
	...
	public void checkDuplicateImageHdSupply() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/hd-supply/hd-supply-contract/");
	...
	public void checkDuplicateImageIndependent() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/independent-stationers-office-supplies/independent-stationers-contract-office-supplies/");
	...
	public void checkDuplicateImageInsightCloud() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/insight-cloud/insight-cloud-contract/");
	...
	public void checkDuplicateImageKnoll() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/knoll/knoll-contract/");
	...
	public void checkDuplicateImageKone() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/kone/kone-contract/");
	...
	public void checkDuplicateImagePremier() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/premier-us-foods/premier-us-foods-contract/");
	...
	public void checkDuplicateImageSafeware() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/safeware-mallory/safeware-mallory-contract/");
	...
	public void checkDuplicateImageTradition() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/tradition-energy/tradition-energy-contract/");
	...
	public void checkDuplicateImageUnicom() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/unicom-government/unicom-contract/");
	...
	public void checkDuplicateImageVirco() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/virco/virco-contract/");
	...
	public void checkDuplicateImageApplied() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/applied-industrial-technologies/applied-industrial-technologies-contract/");
	...
	public void checkDuplicateImageBi() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/bi-incorporated/bi-incorporated-contract/");
	...
	public void checkDuplicateImageCarquest() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/carquest/carquest-contract/");
	...
	public void checkDuplicateImageDlt() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/dlt-solutions/dlt-solutions-contract/");
	...
	public void checkDuplicateImageFisher() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/fisher-science-education/fisher-science-education-contract/");
	...
	public void checkDuplicateImageGarlanddbs() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/garlanddbs-inc/garlanddbs-inc-contract/");
	...
	public void checkDuplicateImageGraybar() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/graybar-telecommunications/graybar-telecommunications-contract/");
	...
	public void checkDuplicateImageHome() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/the-home-depot/the-home-depot-contract/");
	...
	public void checkDuplicateImageHertz() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/hertz-equipment-rental/hertz-equipment-rental-contract/");
	...
	public void checkDuplicateImageUnicomCloud() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/unicom-government-cloud-solutions/unicom-cloud-solutions-contract/");
	...
	public void checkDuplicateImageStationers() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/independent-stationers-school-supplies/independent-stationers-contract-school-supplies/");
	...
	public void checkDuplicateImageInsight() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/insight-public-sector/insight-public-sector-contract/");
	...
	public void checkDuplicateImageKompan() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/kompan/kompan-contract/");
	...
	public void checkDuplicateImageKronos() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/kronos/kronos-contract/");
	...
	public void checkDuplicateImageRicoh() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/ricoh/ricoh-contract/");
	...
	public void checkDuplicateImageServicewear() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/servicewear-apparel/servicewear-apparel-contract/");
	...
	public void checkDuplicateImageTraffic() throws MalformedURLException, IOException {
		System.setProperty("webdriver.chrome.driver", "c://chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("http://test3.uscommunities.org/suppliers/traffic-and-parking-control-co/tapco-contract/");
